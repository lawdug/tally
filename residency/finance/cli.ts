...
// Finance pillar CLI. Shares the standard command set with every pillar;
// adds a `core-root` verb so attestation envelopes can cite the Core
// canon_root this pillar pins against.
process.exit(
  runCli(
    {
